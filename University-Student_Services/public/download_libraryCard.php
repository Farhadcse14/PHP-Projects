...
<?php 
    ...
    $pdf->Image('image/just.png',13, 15, 10, 10);

    $pdf->SetFont('Arial', 'B', 12);
    $pdf->Cell(82, 5, "Jessore University of Science and Technology", 0, 1, 'L');

    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(82, 5, "Jessore-7408, Bangladesh", 0, 1, 'C');
    ...
    $pdf->Multicell(40, 6, "Library Card", 0, 'C', true);
    ...
    $pdf->Image("image/{$std->sig_name}",15, 47, 25, 4);
    $pdf->Image("signature/librarian.jpg",55, 47, 25, 4);
    ...
    $pdf->Cell(80, 5, "3. Any lost or damaged books should be reported to the Library immediately.", 0, 1, 'L');
    $pdf->Cell(80, 3, "4. Students may request a one-time extension (or renewal) of the borrowing period, ", 0, 1, 'L');
    $pdf->Cell(80, 3, "5. provided that no other student has requested the same book.", 0, 1, 'L');

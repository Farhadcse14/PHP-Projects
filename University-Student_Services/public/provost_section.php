  ...
  <body>
    <div class="cng-bg">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-3 text-center">Provost Section</h1>
                <p class="lead text-center">Welcome to Provost section</p>
            </div>
        </div>
    </div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <!-- <div class="text-right"> -->
                            <a href="view_provost.php?sid=<?php echo $id_req->s_id; ?>" class="btn btn-primary" style="float: right;">Show Info</a>
                       <!--  </div> -->

...
<html lang="en">
  ...
  <body>
        ...
        <form action="index.php" method="POST">
            ...
            <div class="form-control col-sm-3" style="margin-top: 50px; margin-left: 570px; border: 2px solid #001a00; background: #001a00; color: #ffffff; margin-bottom: 30px; font-weight: bold; font-size: 25px; text-align: center;">Log In</div>

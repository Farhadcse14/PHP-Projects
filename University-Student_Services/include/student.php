<?php 
    class Student{
        ...
        protected static $db_fields = array('s_id', 'first_name', 'last_name', 'roll', 'registration', 'dept', 'hall', 'resident', 'room', 'mobile', 'dob', 'f_name', 'm_name', 'email', 'session', 'pre_add', 'par_add', 'img_name', 'sig_name', 'b_group', 'gender', 'username', 'password', 'cpassword', 'cgpa',);
    ...
    public static function chairman_login($username="chairman_cse", $password="chairman_cse"){
        global $database;
        $username = $database->escape_value($username);
        $password = $database->escape_value($password);
    ...
    public static function provost_login($username="provost", $password="provost"){
        global $database;
        $username = $database->escape_value($username);
        $password = $database->escape_value($password);
